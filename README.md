...
| `document-governance` | [document-governance/SKILL.md](document-governance/SKILL.md) | `document-governance/` | Interview and stress-test ideas or designs, record outcomes during discussion, and govern documentation, Idea/Backlog, and Runbook lifecycles. | Yes |
