...
- [ ] Exercise loaded routing and implicit selection in authorized fresh host contexts with actual project artifacts before claiming reliable behavioral acceptance. The canceled real-project pilot is not resumed by these source and installation changes.
